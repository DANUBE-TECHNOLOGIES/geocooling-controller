...
class GeoCoolingController:
    ...
    def _thermal_safety(self) -> dict[str, Any]:
        ...
        decision = self.safety_manager.evaluate(
            indoor_temperature_c=driver_status.get("indoor_temperature_c"),
            indoor_humidity_percent=driver_status.get("indoor_humidity_percent"),
            surface_temperature_c=driver_status.get("surface_temperature_c"),
        )
